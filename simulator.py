...
VOL_GDL = 10110.8 # GDL volume in m3
PWR_REF_SUP_GDL = 700.0 # Power reference supply fan in GDL in W
PWR_REF_EXH_GDL = 1300.0 # Power  reference exhaust fan in GDL in W
Q_REF_GDL = 25000.0/3600 # Airflow reference HDL in m3/s
...
Q_MIN = Q_REF_GDL*0.2 # Minimum airflow GDL
...
class Household(object):
    """
    This class contains the load profile of houshold. On initialization it reads a load profile from a CSV
    file generated by BehaveSim and introduces is into a list. The method next_load() returns the current
    load.
